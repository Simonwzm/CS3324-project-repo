...
SAVE_PATH = "./meta_info_AIGCIQA2023_captioned.csv"
...
caption_list_all=[]
image_list = list(range(0,2400))
# print(image_list)
# exit()
# for each element in image_list, add './AGIQA-3K/' before it
meta = pd.read_csv("./AIGCIQA2023/DATA/MOS/mosz3.csv")
image_list = ['./AIGCIQA2023/Image/allimg/allimg/' + str(x) + '.png' for x in image_list]
print(image_list[0])
# exit()
...
# save pd2 to ./pd2.csv
pd2.to_csv("./pd3.csv", index=False)
